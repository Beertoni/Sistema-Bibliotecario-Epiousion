...
<title>Menu | Devolução de Empréstimo</title>
...
<body>
    <img alt="aranha" title="Empreste um livro aqui" src="./Imagens/aranhinha.svg" style="margin-left: 50rem;">
        ...
        <form action="devolverEmprestimo" method="post" class="formcad"> 
        ...
        <img src="./Imagens/livro3.svg" alt="livro3" style="transform: rotateY(180deg); margin-left: 20rem;">
    </div>
